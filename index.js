...
// Note: The GoogleGenAI class is now available globally from the script tag in index.html
                    ...
                    responseSchema: {
                        ...
                        items: {
                            ...
                            properties: {
                                ...
                                domains: { type: "ARRAY", items: { type: "STRING" }, description: 'The domains in this category.' }
                            }
                        }
                    }
                }
